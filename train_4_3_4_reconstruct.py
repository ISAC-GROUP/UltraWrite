...
def train(train_x_src, train_y_src, train_x_trg, train_y_trg, test_x, test_y, uid, range, log_path):
    ...
    checkpoint_callback = ModelCheckpoint(
            dirpath=os.path.join(os.getcwd(), "checkpoint/paper_4_3_4_reconstruct_ckpt"),
    ...
    logger = TensorBoardLogger(
            save_dir=os.path.join(os.getcwd(), "checkpoint/paper_4_3_4_reconstruct_logs"), 
        )
...
# for i in range(1):
#     log_path="checkpoint/paper_4_3_4_TXT/4_3_4_cross_person_reconstruct_train_uid_1_range_" + str(i) + ".txt"
...
# for i in range(1):
#     log_path="checkpoint/paper_4_3_4_TXT/4_3_4_cross_person_reconstruct_train_uid_2_range_" + str(i) + ".txt"
...
# for i in range(1):
#     log_path="checkpoint/paper_4_3_4_TXT/4_3_4_cross_person_reconstruct_train_uid_3_range_" + str(i) + ".txt"
...
# for i in range(1):
#     log_path="checkpoint/paper_4_3_4_TXT/4_3_4_cross_person_reconstruct_train_uid_4_range_" + str(i) + ".txt"
...
# for i in range(1):
#     log_path="checkpoint/paper_4_3_4_TXT/4_3_4_cross_person_reconstruct_train_uid_5_range_" + str(i) + ".txt"
...
# for i in range(1):
#     log_path="checkpoint/paper_4_3_4_TXT/4_3_4_cross_person_reconstruct_train_uid_6_range_" + str(i) + ".txt"
...
# for i in range(1):
#     log_path="checkpoint/paper_4_3_4_TXT/4_3_4_cross_person_reconstruct_train_uid_7_range_" + str(i) + ".txt"
...
# for i in range(1):
#     log_path="checkpoint/paper_4_3_4_TXT/4_3_4_cross_person_reconstruct_train_uid_8_range_" + str(i) + ".txt"
...
# for i in range(1):
#     log_path="checkpoint/paper_4_3_4_TXT/4_3_4_cross_person_reconstruct_train_uid_9_range_" + str(i) + ".txt"
...
for i in range(1):
    log_path="checkpoint/paper_4_3_4_TXT/4_3_4_cross_person_reconstruct_train_uid_10_range_" + str(i) + ".txt"
