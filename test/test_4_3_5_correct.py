...
txtpath = "./check/test435/zclCorrect.txt"
with open(txtpath, "a") as fp:
    fp.write("zcl" + "\n")
fp.close()
...
txtpath = "./check/test435/zpzCorrect.txt"
with open(txtpath, "a") as fp:
    fp.write("zpz" + "\n")
fp.close()
...
txtpath = "./check/test435/wdyCorrect.txt"
with open(txtpath, "a") as fp:
    fp.write("wdy" + "\n")
fp.close()
...
txtpath = "./check/test435/lmqCorrect.txt"
with open(txtpath, "a") as fp:
    fp.write("lmq" + "\n")
fp.close()
...
txtpath = "./check/test435/lczCorrect.txt"
with open(txtpath, "a") as fp:
    fp.write("lcz" + "\n")
fp.close()
...
txtpath = "./check/test435/cwyCorrect.txt"
with open(txtpath, "a") as fp:
    fp.write("cwy" + "\n")
fp.close()
...
txtpath = "./check/test435/lcfCorrect.txt"
with open(txtpath, "a") as fp:
    fp.write("lcf" + "\n")
fp.close()
...
txtpath = "./check/test435/zyCorrect.txt"
with open(txtpath, "a") as fp:
    fp.write("zy" + "\n")
fp.close()
...
txtpath = "./check/test435/cgjCorrect.txt"
with open(txtpath, "a") as fp:
    fp.write("cgj" + "\n")
fp.close()
...
txtpath = "./check/test435/gsCorrect.txt"
with open(txtpath, "a") as fp:
    fp.write("gs" + "\n")
fp.close()
...
txtpath = "./check/test435/TotalCorrect.txt"
with open(txtpath, "a") as fp:
    fp.write("Total" + "\n")
fp.close()
print("Total top 1")
