...
times1_pl_model = PL_Model_4_3_3.pl_model.load_from_checkpoint("/sdo/zcl/AcouWrite/Code/checkpoint/paper_4_3_3_ckpt/4_3_3_synthe_times_1-CER=0.0886-WER=0.2098.ckpt")
times1_model = times1_pl_model.net
times1_model =times1_model.to(device)
times1_model.eval()

times3_pl_model = PL_Model_4_3_3.pl_model.load_from_checkpoint("/sdo/zcl/AcouWrite/Code/checkpoint/paper_4_3_3_ckpt/4_3_3_synthe_times_3-CER=0.0448-WER=0.0944.ckpt")
times3_model = times3_pl_model.net
times3_model= times3_model.to(device)
times3_model.eval()

times5_pl_model = PL_Model_4_3_3.pl_model.load_from_checkpoint("/sdo/zcl/AcouWrite/Code/checkpoint/paper_4_3_3_ckpt/4_3_3_synthe_times_5-CER=0.0273-WER=0.0626.ckpt")
times5_model = times5_pl_model.net
times5_model = times5_model.to(device)
times5_model.eval()

times7_pl_model = PL_Model_4_3_3.pl_model.load_from_checkpoint("/sdo/zcl/AcouWrite/Code/checkpoint/paper_4_3_3_ckpt/4_3_3_synthe_times_7-CER=0.0152-WER=0.0347.ckpt")
times7_model = times7_pl_model.net
times7_model = times7_model.to(device)
times7_model.eval()
...
txtpath = "./check/test433/Times1Correct.txt"
with open(txtpath, "a") as fp:
    fp.write("Time1" + "\n")
fp.close()

times1_outs_top1, times1_outs_top3, times1_outs_top5, times1_labels = test(times1_model, test_x, test_y, top=5)
print("times1 top 1")
getresult(times1_outs_top1, times1_labels, txtpath, 1)
print("times1 top 3")
getresult(times1_outs_top3, times1_labels, txtpath, 3)
print("times1 top 5")
getresult(times1_outs_top5, times1_labels, txtpath, 5)


txtpath = "./check/test433/Times3Correct.txt"
with open(txtpath, "a") as fp:
    fp.write("Time3" + "\n")
fp.close()

times3_outs_top1, times3_outs_top3, times3_outs_top5, times3_labels = test(times3_model, test_x, test_y, top=5)
print("times3 top 1")
getresult(times3_outs_top1, times3_labels, txtpath, 1)
print("times3 top 3")
getresult(times3_outs_top3, times3_labels, txtpath, 3)
print("times3 top 5")
getresult(times3_outs_top5, times3_labels, txtpath, 5)


txtpath = "./check/test433/Times5Correct.txt"
with open(txtpath, "a") as fp:
    fp.write("Time5" + "\n")
fp.close()

times5_outs_top1, times5_outs_top3, times5_outs_top5, times5_labels = test(times5_model, test_x, test_y, top=5)
print("times5 top 1")
getresult(times5_outs_top1, times5_labels, txtpath, 1)
print("times5 top 3")
getresult(times5_outs_top3, times5_labels, txtpath, 3)
print("times5 top 5")
getresult(times5_outs_top5, times5_labels, txtpath, 5)

txtpath = "./check/test433/Times7Correct.txt"
with open(txtpath, "a") as fp:
    fp.write("Time7" + "\n")
fp.close()

times7_outs_top1, times7_outs_top3, times7_outs_top5, times7_labels = test(times7_model, test_x, test_y, top=5)
print("times7 top 1")
getresult(times7_outs_top1, times7_labels, txtpath, 1)
print("times7 top 3")
getresult(times7_outs_top3, times7_labels, txtpath, 3)
print("times7 top 5")
getresult(times7_outs_top5, times7_labels, txtpath, 5)