...
def split_datas(datas, labels):
    ...
    for idx in range(len(labels)):
        ...
        if charlabel in labelsave:
            test_datas.append(data)
            test_labels.append(label)
            test_idx.append(idx)
        else:
            labelsave.append(charlabel)
            train_datas.append(data)
            train_labels.append(label)

    return train_datas, train_labels, test_datas, test_labels, test_idx
...
def train(train_x_src, train_y_src, train_x_trg, train_y_trg, test_x, test_y, uid, range, log_path):
    ...
    pl_model = PL_Model_4_3_4_dann.pl_model(
    ...
    checkpoint_callback = ModelCheckpoint(
            dirpath=os.path.join(os.getcwd(), "checkpoint/paper_4_3_4_dann_ckpt"),
            filename="4_3_4_cross_person_dann_train_"+ uid + "_" + str(range) +"-{CER:.4f}-{WER:.4f}",
            monitor="CER",
            save_top_k=1,
            mode='min'
        )
    ...
    logger = TensorBoardLogger(
            save_dir=os.path.join(os.getcwd(), "checkpoint/paper_4_3_4_dann_logs"), 
        )
...
# for i in range(1):
#     log_path="checkpoint/paper_4_3_4_TXT/4_3_4_cross_person_dann_train_uid_1_range_" + str(i) + ".txt"
#     train_x_trg, train_y_trg, test_x, test_y, test_idx = split_datas(datas=data_1,labels=label_1)
#     test_idx = np.array(test_idx)
#     np.save(os.path.join(path, "user1_test_idx.npy"), test_idx)
...
# for i in range(1):
#     log_path="checkpoint/paper_4_3_4_TXT/4_3_4_cross_person_dann_train_uid_2_range_" + str(i) + ".txt"
#     train_x_trg, train_y_trg, test_x, test_y, test_idx = split_datas(datas=data_2,labels=label_2)
#     test_idx = np.array(test_idx)
#     np.save(os.path.join(path, "user2_test_idx.npy"), test_idx)
...
# for i in range(1):
#     log_path="checkpoint/paper_4_3_4_TXT/4_3_4_cross_person_dann_train_uid_3_range_" + str(i) + ".txt"
#     train_x_trg, train_y_trg, test_x, test_y, test_idx = split_datas(datas=data_3,labels=label_3)
#     test_idx = np.array(test_idx)
#     np.save(os.path.join(path, "user3_test_idx.npy"), test_idx)
...
# for i in range(1):
#     log_path="checkpoint/paper_4_3_4_TXT/4_3_4_cross_person_dann_train_uid_4_range_" + str(i) + ".txt"
#     train_x_trg, train_y_trg, test_x, test_y, test_idx = split_datas(datas=data_4,labels=label_4)
#     test_idx = np.array(test_idx)
#     np.save(os.path.join(path, "user4_test_idx.npy"), test_idx)
...
# for i in range(1):
#     log_path="checkpoint/paper_4_3_4_TXT/4_3_4_cross_person_dann_train_uid_5_range_" + str(i) + ".txt"
#     train_x_trg, train_y_trg, test_x, test_y, test_idx = split_datas(datas=data_5,labels=label_5)
#     test_idx = np.array(test_idx)
#     np.save(os.path.join(path, "user5_test_idx.npy"), test_idx)
...
# for i in range(1):
#     log_path="checkpoint/paper_4_3_4_TXT/4_3_4_cross_person_dann_train_uid_6_range_" + str(i) + ".txt"
#     train_x_trg, train_y_trg, test_x, test_y, test_idx = split_datas(datas=data_6,labels=label_6)
#     test_idx = np.array(test_idx)
#     np.save(os.path.join(path, "user6_test_idx.npy"), test_idx)
...
# for i in range(1):
#     log_path="checkpoint/paper_4_3_4_TXT/4_3_4_cross_person_dann_train_uid_7_range_" + str(i) + ".txt"
#     train_x_trg, train_y_trg, test_x, test_y, test_idx = split_datas(datas=data_7,labels=label_7)
#     test_idx = np.array(test_idx)
#     np.save(os.path.join(path, "user7_test_idx.npy"), test_idx)
...
# for i in range(1):
#     log_path="checkpoint/paper_4_3_4_TXT/4_3_4_cross_person_dann_train_uid_8_range_" + str(i) + ".txt"
#     train_x_trg, train_y_trg, test_x, test_y, test_idx = split_datas(datas=data_8,labels=label_8)
#     test_idx = np.array(test_idx)
#     np.save(os.path.join(path, "user8_test_idx.npy"), test_idx)
...
# for i in range(1):
#     log_path="checkpoint/paper_4_3_4_TXT/4_3_4_cross_person_dann_train_uid_9_range_" + str(i) + ".txt"
#     train_x_trg, train_y_trg, test_x, test_y, test_idx = split_datas(datas=data_9,labels=label_9)
#     test_idx = np.array(test_idx)
#     np.save(os.path.join(path, "user9_test_idx.npy"), test_idx)
...
for i in range(1):
    log_path="checkpoint/paper_4_3_4_TXT/4_3_4_cross_person_dann_train_uid_10_range_" + str(i) + ".txt"
    train_x_trg, train_y_trg, test_x, test_y, test_idx = split_datas(datas=data_10,labels=label_10)
    test_idx = np.array(test_idx)
    np.save(os.path.join(path, "user10_test_idx.npy"), test_idx)
